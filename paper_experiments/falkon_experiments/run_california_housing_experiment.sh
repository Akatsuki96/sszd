...
wait
python3 california_housing_experiment.py 'ds' 500  --ds-theta 0.5 --ds-rho 2.0  --ds-min-alpha 1e-9 --ds-max-alpha 100.0 --ds-alpha 10.0 --ds-l 1 --ds-dirtype 'spherical' --ds-constant 0.1 --reps 10 --out-file 'probds_sp_2'
