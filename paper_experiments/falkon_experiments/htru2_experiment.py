...
data = pd.read_csv("./data/htru2/HTRU_2.csv", header=None)
...
X_train, X_test, Y_train, Y_test = train_test_split(X, y, test_size=0.33, random_state=rnd_state, stratify=y, shuffle=True)



X_test, Y_test = torch.from_numpy(X_test), torch.from_numpy(Y_test)

X_tr, X_vl, y_tr, y_vl = train_test_split(X_train, Y_train, test_size=0.33, stratify=Y_train, shuffle=True, random_state=rnd_state)
