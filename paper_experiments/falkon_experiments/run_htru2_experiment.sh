nohup python3 htru2_experiment.py "sszd" 100 --sszd-alpha 10.0 --sszd-l 4 --sszd-h 1.0 --sszd-dirtype 'orthogonal' --reps 5 --out-file "sszd_4_orth" > out_sszd4 &
nohup python3 htru2_experiment.py "sszd" 100 --sszd-alpha 10.0 --sszd-l 9 --sszd-h 1.0 --sszd-dirtype 'orthogonal' --reps 5 --out-file "sszd_9_orth" > out_sszd9 &
wait
...
nohup python3 htru2_experiment.py 'cobyla'  100   --reps 5 --out-file 'cobyla' &
