...
target = StronglyConvex(d=d, dtype=dtype, device=device)
...
coo_hd = SSZD(P = P2_c, alpha=StepSize(init_value= 1e-2 *0.5 , mode='sqrt'), h=StepSize(init_value=1e-8, mode='constant'))
sph_d = SSZD(P = P1_s, alpha=StepSize(init_value= 1e-2 , mode='sqrt'), h=StepSize(init_value=1e-8, mode='constant'))
sph_hd = SSZD(P = P2_s, alpha=StepSize(init_value= 1e-2 * 0.5 , mode='sqrt'), h=StepSize(init_value=1e-8, mode='constant'))
