...
target = PLNonConvexFunction(d, dtype=dtype, device=device)
...
sph_d = SSZD(P = P1_s, alpha=StepSize(init_value= 8e-3 , mode='sqrt'), h=StepSize(init_value=1e-8,   mode=h_mode))
nest = SSZD(P=P_nest, alpha=StepSize(init_value= 45e-5 , mode='sqrt'), h=StepSize(init_value=1e-8,    mode=h_mode))
duchi = SSZD(P=P_duchi, alpha=StepSize(init_value= 65e-6 , mode='sqrt'), h=StepSize(init_value=1e-8,  mode=h_mode))
flax = SSZD(P=P_flax, alpha=StepSize(init_value= 5e-2 , mode='sqrt'), h=StepSize(init_value=1e-8,    mode=h_mode))
berash = SSZD(P=P_beras, alpha=StepSize(init_value= 71e-4 , mode='sqrt'), h=StepSize(init_value=1e-8, mode=h_mode))
