...
def sq_norm_experiment(dirtype, fn, reps=10):
    ...
    for j in range(len(alpha_values)):
        alpha = lambda k: l/d * (k**(-1/alpha_values[j])) * 1e-1 
...
reps = 2
results_coord = sq_norm_experiment("coordinate", NonConvPL, reps=reps)
plot_results("pl_coord", results_coord, alpha_values)
print("[PL] Coordinate completed!")
results_sph = sq_norm_experiment("spherical", NonConvPL, reps=reps)
