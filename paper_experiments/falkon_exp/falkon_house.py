...
coo_d = SSZD(P = P1_c, alpha=StepSize(init_value= 10.0  , mode='sqrt'), h=StepSize(init_value=1e-2, mode='lin'))
sph_d = SSZD(P = P1_s, alpha=StepSize(init_value= 10.0  , mode='sqrt'), h=StepSize(init_value=1e-2, mode='lin'))
