...
def ds_experiment(Xtr, Xte, ytr, yte, options, reps=5):
    ...
    optimizer = GDS(init_alpha=10.0, options=options)
...
sketch_unit_options = GDSOptions(9, alpha_max = 10000.0, exp_factor=2, cont_factor=0.5, gen_strat="random_unit", sketch=("gaussian", l))
sketch_orth_options = GDSOptions(9, alpha_max = 10000.0, exp_factor=2, cont_factor=0.5, gen_strat="random_orth", sketch=("orthogonal", l))
unit_options = GDSOptions(9, alpha_max = 10000.0, exp_factor=2, cont_factor=0.5, gen_strat="random_unit")
orth_options = GDSOptions(9, alpha_max = 10000.0, exp_factor=2, cont_factor=0.5, gen_strat="random_orth")
n_half_options = GDSOptions(9, alpha_max = 10000.0, exp_factor=2, cont_factor=0.5, gen_strat="n_half")
